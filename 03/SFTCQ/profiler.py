...
A Profiler object tracks the list, the number of comparisons and exchanges,
and the running time. The Profiler can also print a trace and can create
a list of unique or duplicate numbers.
...
p = Profiler()
p.test(selectionSort, size = 5 , comp = Ture , exch = True , trace = True)
...
class Profiler(object):
	...
	exch = True, trace = False):
		...
		size: the size of the lyst, 10 by default
